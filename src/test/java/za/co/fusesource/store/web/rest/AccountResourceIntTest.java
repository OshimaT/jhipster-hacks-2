package za.co.fusesource.store.web.rest;

import za.co.fusesource.store.config.Constants;
import za.co.fusesource.store.StoreApp;
import za.co.fusesource.store.domain.Authority;
import za.co.fusesource.store.domain.User;
import za.co.fusesource.store.repository.AuthorityRepository;
import za.co.fusesource.store.repository.UserRepository;
import za.co.fusesource.store.security.AuthoritiesConstants;
import za.co.fusesource.store.service.MailService;
import za.co.fusesource.store.service.dto.UserDTO;
import za.co.fusesource.store.service.dto.PasswordChangeDTO;
import za.co.fusesource.store.web.rest.errors.ExceptionTranslator;
import za.co.fusesource.store.web.rest.vm.KeyAndPasswordVM;
import za.co.fusesource.store.web.rest.vm.ManagedUserVM;
import za.co.fusesource.store.service.UserService;
